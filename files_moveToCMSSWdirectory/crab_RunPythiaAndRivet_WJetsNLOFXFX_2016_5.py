...
config.General.requestName = '2016_WJetsNLOFXFX_NonPertON_dataset5'
config.section_('JobType')
config.JobType.psetName = 'runPythia8AndRivetAnalysis_WJetsNLOFXFX_2016.py'
...
# ---
#config.Data.unitsPerJob = 11 # for 2015 dataset
config.Data.unitsPerJob = 3 # for 2016 dataset (2017, 2018?)
# ---
...
config.Data.outputDatasetTag = '2016_WJetsNLOFXFX_NonPertON'

...
config.General.requestName = '2017_WJetsNLOFXFX_NonPertON_dataset10'
config.section_('JobType')
config.JobType.psetName = 'runPythia8AndRivetAnalysis_WJetsNLOFXFX_2017.py'
config.JobType.pluginName = 'Analysis'
config.JobType.maxJobRuntimeMin = 2200
...
config.Data.outLFNDirBase = '/store/user/awisecar/NPCorrections_WJetsRun2_dir2/'
config.Data.outputDatasetTag = '2017_WJetsNLOFXFX_NonPertON'

...
config.General.requestName = '2017_WJetsNLOFXFX_NonPertOFF_dataset10'
config.section_('JobType')
config.JobType.psetName = 'runPythia8AndRivetAnalysis_WJetsNLOFXFX_HadMpiOFF_2017.py'
...
config.Data.outputDatasetTag = '2017_WJetsNLOFXFX_NonPertOFF'

...
config.General.requestName = '2016_WJetsLOMLM_NonPertOFF'
config.section_('JobType')
config.JobType.psetName = 'runPythia8AndRivetAnalysis_WJetsLOMLM_HadMpiOFF_old2015.py'
...
config.Data.outputDatasetTag = '2016_WJetsLOMLM_NonPertOFF'

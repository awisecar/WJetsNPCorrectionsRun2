...
# with command line options: Configuration/GenProduction/python/SUS-RunIIWinter15GS-00145-fragment.py -s GEN --datatier=GEN-SIM-RAW --conditions auto:mc --eventcontent RAWSIM --no_exec -n 100 --python_filename=rivet_WJets_MLM_cfg.py --customise=Configuration/GenProduction/rivet_customize.py
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        pythia8CUEP8M1Settings = cms.vstring('Tune:pp 14',
                                             ...
                                             #'HadronLevel:Hadronize = off', #switch off the hadronization
            'Tune:ee 7', 
        ...
        pythia8CommonSettings = cms.vstring('Tune:preferLHAPDF = 2', 
            ...
            'ParticleDecays:allowPhotonRadiation = off', #switch off for FSR effect
            'TimeShower:QEDshowerByL = off' #switch off for FSR effect
                                            )
    ),
...
process.rivetAnalyzer.AnalysisNames = cms.vstring('CMS_SMP_13TEV_WJETS')
process.rivetAnalyzer.OutputFile = cms.string('wjets13tev.yoda')
